//Micha N , simple link routines cc3100
// Station mode ,  constant IP
/**/
#include <stdint.h>
#include <stdbool.h>
#include "main.h"
...
#define CONFIG_IP       SL_IPV4_VAL(10,0,0,9)       /* Static IP to be configured */
#define AP_MASK         SL_IPV4_VAL(255,0,0,0)      /* Subnet Mask for the station */
#define AP_GATEWAY      SL_IPV4_VAL(10,0,0,138)        /* Default Gateway address */
#define AP_DNS          SL_IPV4_VAL(10,0,0,138)            /* DNS Server Address */
...
void cc3100Task(void *pvParameters);
...
/* do not USE_DHCP */
    ...
    CLI_Write((_u8 *)" Turn ON HTTP server\n\r");
